...
class creat (object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 70, 244, 459))
        ...
        self.comboBox.setMaxVisibleItems(19)
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(680, 70, 302, 449))
...
"Welcome to Automated Designing System. Please use the system STEP by STEP."))
        ...
        self.comboBox_type.setItemText(0, _translate("MainWindow", "A60560"))
        self.comboBox_type.setItemText(1, _translate("MainWindow", "A60345"))
        self.comboBox_type.setItemText(2, _translate("MainWindow", "A60254"))
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "塗裝1"))
        self.comboBox.setItemText(1, _translate("MainWindow", "塗裝2"))
        self.comboBox.setItemText(2, _translate("MainWindow", "塗裝3"))
        self.comboBox.setItemText(3, _translate("MainWindow", "塗裝4"))
        self.comboBox.setItemText(4, _translate("MainWindow", "塗裝5"))
