...
class creat(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(1010, 600))
        MainWindow.setMaximumSize(QtCore.QSize(1010, 600))
        MainWindow.setSizeIncrement(QtCore.QSize(1010, 600))
        ...
        self.tableWidget.setGeometry(QtCore.QRect(270, 70, 421, 491))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 70, 251, 488))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(700, 390, 302, 131))
        ...
        self.label_window_pic = QtWidgets.QLabel(self.centralwidget)
        self.label_window_pic.setGeometry(QtCore.QRect(700, 70, 300, 300))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_type.setItemText(0, _translate("MainWindow", "AS6050"))
        self.comboBox_type.setItemText(1, _translate("MainWindow", "AS6058"))
        self.comboBox_type.setItemText(2, _translate("MainWindow", "AS6059"))
        self.label_6.setText(_translate("MainWindow", "設定烤漆顏色"))
